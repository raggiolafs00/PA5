...
/*
As your final blow lands, the massive knight staggers backwards and falls to the ground with a deafening crash. 
For a moment, there is silence in the chamber as you catch your breath and survey the aftermath of the battle.

But then, something strange begins to happen. 
The knight's armor begins to glow with an eerie light, and you feel a sudden blast of heat as the air around you starts to ripple and warp.

Suddenly, there is an explosion of energy that sends you hurtling through the air.
You fly backwards, crashing through the door behind you!

*/

void theInnerSanctum(Person &character) {
    int option, cont;
    Boss *godrick = new Boss("Godrick the Hollow", 150, 5, 3, 20, 50, "Longsword", 12, "Death Plague", "Boss");
    ...
    cin >> cont;
    system("clear");
    cout << "Godrick the Wizard: 'I see you have defeated my champion. Well done, " << character.getName() << ".'" << endl;
    cout << "Godrick the Wizard: 'But now, you must face me if you wish to leave this place.'" << endl;
    cout << "Enter 0 to fight Godrick the Wizard: " << endl;
    cin >> cont;
    system("clear");
